...
public class LobbyMessageUI : MonoBehaviour
{
    ...
    private void KitchenGameMultiplayer_OnFailedToJoinGame(object sender, System.EventArgs e)
    {
        ...
        {
            ShowMessage("Failed to connect to server".ToUpper());
        }
        else
        {
